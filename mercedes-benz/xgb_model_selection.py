...
cv_mean, cv_std = perform_cv(xgb_params, eng_train, 5, 6)
print('cv_mean: ' + str(cv_mean) + ', cv_std: ' + str(cv_std))
print()

feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':True, 'PCA':True,
                  'ICA':True, 'GRP':True, 'SRP':True, 'SparseThreshold':0.0025}
print(xgb_params)
print(feature_config)     
...
feature_config = {'magic':True, 'ID':True, 'n_comp':18, 'tSVD':True, 'PCA':True,
                  'ICA':True, 'GRP':True, 'SRP':True, 'SparseThreshold':0.0}
print(xgb_params)
print(feature_config)     
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':True, 'PCA':True,
                  'ICA':True, 'GRP':True, 'SRP':True, 'SparseThreshold':0.005}
print(xgb_params)
print(feature_config)     
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':True, 'PCA':True,
                  'ICA':True, 'GRP':True, 'SRP':True, 'SparseThreshold':0.01}
print(xgb_params)
print(feature_config)     
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':False, 'PCA':False,
                  'ICA':False, 'GRP':False, 'SRP':False, 'SparseThreshold':0.0025}
print(xgb_params)
print(feature_config)     
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':False, 'PCA':False,
                  'ICA':False, 'GRP':False, 'SRP':False, 'SparseThreshold':0.005}
print(xgb_params)
print(feature_config)     
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':False, 'PCA':False,
                  'ICA':False, 'GRP':False, 'SRP':False, 'SparseThreshold':0.01}
print(xgb_params)
print(feature_config)     
...
###############################################################################
# OK - I'm convinced that we don't need PCA/etc for this task. Let's increase 
# the number of trees and run again
...
###############################################################################
#  Let's increase the number of trees and run again
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':False, 'PCA':True,
                  'ICA':False, 'GRP':False, 'SRP':False, 'SparseThreshold':0.0}
print(xgb_params)
print(feature_config)     

eng_train, eng_test = perform_feature_engineering(train,test,feature_config)
cv_mean, cv_std = perform_cv(xgb_params, eng_train, 5, 12)
print('cv_mean: ' + str(cv_mean) + ', cv_std: ' + str(cv_std))
print()

feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':False, 'PCA':True,
                  'ICA':False, 'GRP':False, 'SRP':False, 'SparseThreshold':0.00125}
print(xgb_params)
print(feature_config)     
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':False, 'PCA':True,
                  'ICA':False, 'GRP':False, 'SRP':False, 'SparseThreshold':0.00375}
print(xgb_params)
print(feature_config)   
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':False, 'PCA':True,
                  'ICA':False, 'GRP':False, 'SRP':False, 'SparseThreshold':0.0075}
print(xgb_params)
print(feature_config)  
...
feature_config = {'magic':True, 'ID':True, 'n_comp':12, 'tSVD':True, 'PCA':True,
                  'ICA':True, 'GRP':True, 'SRP':True, 'SparseThreshold':0.025}
print(xgb_params)
print(feature_config)     
